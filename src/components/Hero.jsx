      ...
      <div className="container" style={{ position: 'relative', zIndex: 2, display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '3rem', alignItems: 'center' }}>
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', marginBottom: '1rem', flexWrap: 'wrap' }}>
            <div style={{
              position: 'relative', width: 95, height: 95, borderRadius: '50%', padding: 3,
              background: 'linear-gradient(135deg, var(--neon-cyan), var(--neon-indigo), var(--neon-purple))',
              boxShadow: '0 0 25px rgba(6, 182, 212, 0.4)', flexShrink: 0
            }}>
              <img src="/assets/images/fitsum.png" alt="Fitsum Mulugeta" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '50%' }} />
            </div>
            <div>
              <h1 style={{ fontFamily: 'var(--font-heading)', fontSize: '3.6rem', fontWeight: 900, lineHeight: 1.1, margin: 0 }}>
                Hi, I'm <span className="gradient-text">Fitsum Mulugeta</span>
              </h1>
            </div>
          </div>
        ...
        {/* Code Card changed to Laravel / PHP (FitsumProfile.php) */}
        <div className="hero-code-card" style={{ background: '#0d1322', border: '1px solid rgba(99, 102, 241, 0.3)', borderRadius: 20, overflow: 'hidden', boxShadow: '0 20px 50px rgba(0,0,0,0.6)' }}>
          <div style={{ background: '#141c2e', padding: '0.8rem 1.2rem', display: 'flex', alignItems: 'center', gap: '0.5rem', borderBottom: '1px solid var(--border-glass)' }}>
            ...
            <span style={{ marginLeft: 'auto', color: 'var(--text-sub)', fontFamily: 'var(--font-mono)', fontSize: '0.8rem' }}>FitsumProfile.php</span>
          </div>
          <div style={{ padding: '1.8rem', fontFamily: 'var(--font-mono)', fontSize: '0.88rem', color: '#e2e8f0', lineHeight: 1.7 }}>
            <div><span style={{ color: '#f472b6' }}>&lt;?php</span></div>
            <br />
            <div><span style={{ color: '#f472b6' }}>namespace</span> App\Developer;</div>
            <br />
            <div><span style={{ color: '#f472b6' }}>class</span> <span style={{ color: '#38bdf8' }}>FitsumMulugeta</span> <span style={{ color: '#f472b6' }}>implements</span> FullStackDeveloper</div>
            <div>&#123;</div>
            <div style={{ paddingLeft: '1.2rem' }}><span style={{ color: '#f472b6' }}>public string</span> <span style={{ color: '#fbbf24' }}>$company</span> = <span style={{ color: '#a3e635' }}>'Excelloite'</span>;</div>
            <div style={{ paddingLeft: '1.2rem' }}><span style={{ color: '#f472b6' }}>public array</span> <span style={{ color: '#fbbf24' }}>$coreStack</span> = [<span style={{ color: '#a3e635' }}>'Laravel'</span>, <span style={{ color: '#a3e635' }}>'PHP'</span>, <span style={{ color: '#a3e635' }}>'React'</span>, <span style={{ color: '#a3e635' }}>'MySQL'</span>];</div>
            <br />
            <div style={{ paddingLeft: '1.2rem' }}><span style={{ color: '#f472b6' }}>public function</span> <span style={{ color: '#38bdf8' }}>getMission</span>(): <span style={{ color: '#f472b6' }}>string</span></div>
            <div style={{ paddingLeft: '1.2rem' }}>&#123;</div>
            <div style={{ paddingLeft: '2.4rem' }}><span style={{ color: '#f472b6' }}>return</span> <span style={{ color: '#a3e635' }}>'Building scalable enterprise systems & APIs.'</span>;</div>
            <div style={{ paddingLeft: '1.2rem' }}>&#125;</div>
            <div>&#125;</div>
          </div>
        </div>
